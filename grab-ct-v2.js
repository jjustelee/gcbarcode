(async () => {
  ...
  const STORAGE_KEY = 'grabCtV2Settings';
  const PANEL_ID = 'ct-location-grab-v2-modal';
  const STYLE_ID = 'ct-location-grab-v2-style';
  const GLOBAL_ABORT_KEY = '__grabCtV2AbortController';
